# Generated by Django 4.2.4 on 2023-09-24 14:07
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('lemmikkirotu', models.CharField(default='laku', max_length=20)),
                ('unitprice', models.DecimalField(decimal_places=2, default=1.0, max_digits=8)),
                ('unitsinstock', models.IntegerField(default=3)),
                ('kasvattaja', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.kasvattaja')),
            ],
        ),
    ]
